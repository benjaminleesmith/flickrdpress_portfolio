...
module PortfolioHelper
  def photo_width(photo)
    if photo.width_large.to_i > photo.height_large.to_i
      500
    else
      ((500.0/photo.height_large.to_f) * photo.width_large.to_i).to_i
    end
  end

  def photo_height(photo)
    if photo.width_large.to_i > photo.height_large.to_i
      ((500.0/photo.width_large.to_f) * photo.height_large.to_i).to_i
    else
      500
    end
  end
